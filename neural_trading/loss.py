...
class TradingLoss(nn.Module):
    ...
    def forward(
        ...
        # Treat winners (label 0) as positive returns, losers (label 1) as negative
        preds = direction_logits.argmax(dim=1)
        correct = (preds == true_labels).float()
        # Simulate PnL: +magnitude for correct, -magnitude for incorrect
        ...
        # 4. Confidence calibration — confidence should be high when correct
